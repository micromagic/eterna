...
public class BaseManager
{
	...
	public BaseManager copy(boolean clear)
	{
		BaseManager other = new BaseManager();
	...
	protected static abstract class PartSQL
	{
		...
		public abstract PartSQL copy(boolean clear, BaseManager manager);
	...
	protected static class ParameterPart extends PartSQL
	{
		...
		public PartSQL copy(boolean clear, BaseManager manager)
		{
	...
	protected static class SubFlagPart extends PartSQL
	{
		...
		public String getSQL()
		{
			return this.insertString == null ? BaseManager.SUBPART_FLAG + "" : this.insertString;
		}
	}
	...
	protected static class SubPart extends PartSQL
	{
				...
				throws EternaException
		{
			if (this.parts == null)
			{
				...
				ArrayList subSQLList = new ArrayList();
				ArrayList subList = new ArrayList();
				BaseManager.parse(this.template, true, partList, paramList, subSQLList, subList);
	...
	protected static class ConstantSQL extends PartSQL
	{
				...
				throws EternaException
		{
			if (this.value == null)
			{
				...
				ArrayList subSQLList = new ArrayList();
				ArrayList subList = new ArrayList();
				BaseManager.parse(this.value, true, partList, paramList, subSQLList, subList);
