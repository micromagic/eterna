...
public class BaseImpl extends AbstractBase
{
	/**
	 * 全局的日志的记录类型.
	 */
	...
	static
	{
		try
		{
			Utility.addMethodPropertyManager(LOG_TYPE_FLAG,
					BaseImpl.class, "setGlobalLogType");
		}
		catch (Throwable ex)
		{
	...
	{
		super.copy(copyObj);
		BaseImpl other = (BaseImpl) copyObj;
	...
	private static void logSQL(Base base, long usedTime, Throwable exception, Element logNode)
	 ...
	 */
	protected static boolean logSQL(Base base, long usedTime, Throwable exception,
			Connection conn)
			throws SQLException, EternaException
	{
